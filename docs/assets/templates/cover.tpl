...
<p>仅供离线查阅 | {{ config.extra.version }} </p>
<p>
  <span style="border:1.5px solid var(--md-primary-fg-color); border-radius: 10px;padding: 4px;"><span class="twemoji"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
...
<a href="{{ config.site_url }}">在线版本</a></span>
</p>
